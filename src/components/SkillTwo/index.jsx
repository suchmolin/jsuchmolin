export default function SkillTwo() {
  return (
    <div
      id="SkillSecTwo"
      className="skillSec flex flex-col items-center -ml-20 mr-20 md:pt-16"
    >
      <div className="w-12/12">
        ...
        <div className=" flex flex-col md:flex-row gap-5 mt-10 min-h-40  px-20">
      ...
      <div className="w-full flex flex-col items-center gap-5 mt-5 md:mt-16">
