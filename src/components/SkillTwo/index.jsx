export default function SkillTwo() {
  return (
    <div
      id="SkillSecTwo"
      className="skillSec flex flex-col items-center -ml-20 mr-20"
    >
      <div className="w-12/12">
        ...
        <div className=" flex gap-5 mt-10 min-h-40  px-20">
          <div className="imgCont">
            <img src="./vitelogo.png" alt="" />
          </div>
          <div className="imgContHzt">
            <img src="./nextjslogo.png" alt="" />
          </div>
          <div className="imgCont">
            <img src="./firebaselogo.png" alt="" />
          </div>
          <div className="imgCont">
            <img src="./sqllogo.png" alt="" />
          </div>
        </div>
      </div>
      <div className="w-full flex flex-col items-center gap-5 mt-16">
        ...
        <div className="flex gap-5">
          <div className="flex flex-col justify-center items-center">
            <img style={{ width: "30px" }} src="./spanishflag.png" alt="" />

            <p className="text-xs  leading-3">Spanish</p>
            <p className="extraSmall  leading-3">{"(NATIVE)"}</p>
          </div>
          <div className="flex flex-col justify-center items-center">
            <img style={{ width: "30px" }} src="./usaflag.png" alt="" />
