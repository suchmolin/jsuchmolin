export default function SkillOne() {
  return (
    <div
      id="SkillSecOne"
      className="skillSec flex flex-col md:flex-row w-full min-h-full items-center md:mr-40 pt-16 md:pt-0"
    >
      <div className="flex w-full justify-center md:hidden mb-10">
      ...
      <div className="w-10/12 md:w-12/12 md:w-9/12">
        <div className="flex gap-5  mt-10  md:px-20 items-center justify-center">
      ...
      <div className="hidden md:block w-0 md:w-3/12 h-3/4 border-l-4 border-gray-600 py-4 ">
